  ...
  return new Promise(resolve => {
    ...
    const interval = setInterval(() => {
      ...
      process.stdout.write(
        `\r${chalk.hex(BRAND_COLORS.accent)(frame)} ${chalk.hex(BRAND_COLORS.muted)(message)}...`
      );
      ...
      if (elapsed >= duration) {
        ...
        process.stdout.write(
          `\r${chalk.hex(BRAND_COLORS.success)('✓')} ${chalk.hex(BRAND_COLORS.muted)(message)} complete!\n`
        );
        resolve();
      }
    }, 80);
...
export function printFeatureHighlight(): void {
  ...
  console.log(
    '   ' + chalk.hex(BRAND_COLORS.primary)('🎯') + ' ' + chalk.white('Conventional Commits')
  );
  console.log(
    '   ' + chalk.hex(BRAND_COLORS.primary)('🤖') + ' ' + chalk.white('AI-Powered Suggestions')
  );
  console.log(
    '   ' + chalk.hex(BRAND_COLORS.primary)('🎨') + ' ' + chalk.white('Beautiful Emoji Support')
  );
  console.log(
    '   ' +
      chalk.hex(BRAND_COLORS.primary)('⚡') +
      ' ' +
      chalk.white('Lightning Fast & Interactive')
  );
  console.log(
    '   ' + chalk.hex(BRAND_COLORS.primary)('🔧') + ' ' + chalk.white('Highly Configurable')
  );
  console.log('');
}
